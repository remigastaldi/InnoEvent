...
public class IrregularStandingSectionController extends ViewController {
  ...
  public void init() {
    ...
    section_elevation_input.setText(Double.toString(polygon.getStandingData().getElevation()));
    section_nb_people_input.setText(Integer.toString(polygon.getStandingData().getNbPeople()));
  ...
  private void onKeyReleased() {
    if (checkInputs()) {
      ...
      try {
        ...
        if (section_nb_people_input.isFocused())
          Core().setStandingNbPeople(polygon.getID(), Integer.parseInt(section_nb_people_input.getText()));
  ...
  @FXML
  private void SectionStandingToSitting() {
    InnoPolygon polygon = (InnoPolygon) getIntent();
